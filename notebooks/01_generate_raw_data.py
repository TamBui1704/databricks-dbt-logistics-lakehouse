...
# MAGIC %md
# MAGIC ## 1. Tạo dữ liệu Dimensions (Ghi đè)
...
# MAGIC %md
# MAGIC ## 2. Tạo dữ liệu Facts có phân phối thời gian thực tế
...
# MAGIC %md
# MAGIC ## 3. Lưu xuống Delta Tables
...
print("Hoàn tất sinh 10 TRIỆU dữ liệu mẫu vào Unity Catalog!")
